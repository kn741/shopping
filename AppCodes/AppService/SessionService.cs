...
public static class SessionService
{
    ...
    public static string ProductNo
    {
        ...
        {
            string str_value = "Product";
            if (_context != null) str_value = _context.Session.Get<string>("ProductNo");
            if (str_value == null) str_value = "ProductNo";
            return str_value;
        }
        set
        { _context?.Session.Set<string>("ProductNo", value); }
    }

    /// <summary>
    /// 設定商品編號
    /// </summary>
    public static void SetProductNo(string prodNo)
    {
        ProductNo = prodNo;
    }
